...
<div class="main-content-div-outer">
    <div class="container">
        <div class="main-content-div-inner background-none">
            <div class="attorney-profile-outer-div">
                <div class="col-md-4 left visible-lg visible-md">
                    <h2><?php echo $data['attorney_name_profile_page']; ?></h2>
                    <div class="video-iframe">
                        <img src="<?php echo $data['video_profile_page']; ?>"/>
                    </div>
                    <h3><?php echo $data['review_profile_page']; ?> Reviews<span><img src="<?php echo get_template_directory_uri(); ?>/images/big_star.png"></span></h3>
                    ...
                    <div class="tabs-div">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="other-attorney">
                                ...
                                <span class="more-link"><a href="<?php echo $data['more_link_profile_page2']; ?>">(More)</a></span>
                                <div class="bio-bottom-area">
                                    <div class="star-pic"><img src="<?php echo get_template_directory_uri(); ?>/images/small_stars.png"></div>
                                    <h4><?php echo $data['review_profile_page2']; ?>  Reviews</h4>
                                </div> 
                            </div>
                        </div>
                        <script>
                ...
                <div class="col-md-4 left visible-sm visible-xs">
                    <div class="tabs-div">
                        <ul class="nav nav-tabs" id="myTabs">
                            <li class="active"><a href="#why-clients" data-toggle="tab"><?php echo $data['tab1_profile_page']; ?></a></li>
                            <li><a href="#other-attorneys" data-toggle="tab"><?php echo $data['tab2_profile_page']; ?></a></li>
                        </ul>
